...
void FillMaskPart::compile() noexcept {
  ...
  cc->mov(repeat, x86::ptr_32(cmdPtr, BL_OFFSET_OF(MaskCommand, _x1)));
  cc->sub(y, 1);
  cc->jz(L_End);
  ...
  compOpPart()->advanceY();
  cc->sub(repeat, 1);
  cc->mov(x86::ptr_32(cmdPtr, BL_OFFSET_OF(MaskCommand, _x1) - kMaskCmdSize), repeat);
  ...
  cc->mov(cmdType, x86::ptr_32(cmdPtr, BL_OFFSET_OF(MaskCommand, _x0AndType)));
  ...
  cc->mov(cmdType, x86::ptr_32(cmdPtr, kMaskCmdSize + BL_OFFSET_OF(MaskCommand, _x0AndType)));
  cc->add(cmdPtr, kMaskCmdSize);
