  ...
  switch (n.value()) {
    case 1: {
      if (isAlignedBlit()) {
        ...
        pc->x_fetch_pixel(p, PixelCount(1), flags, format(), x86::ptr(f->srcp1), Alignment(4));
        advanceXByOne();
      }
      else {
        x86::Gp idx;
    ...
    case 4: {
      if (isAlignedBlit()) {
        ...
        pc->x_fetch_pixel(p, PixelCount(4), flags, format(), x86::ptr(f->srcp1), Alignment(4));
    ...
    case 8: {
      if (isAlignedBlit()) {
        ...
        pc->x_fetch_pixel(p, PixelCount(8), flags, format(), x86::ptr(f->srcp1), Alignment(4));
